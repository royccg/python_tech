...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 741, 511))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(120, 20, 201, 351))
        ...
        self.spinBox.setMaximumSize(QtCore.QSize(200, 20))
