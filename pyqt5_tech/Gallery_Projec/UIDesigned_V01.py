...
# @Last Modified time: 2020-04-27 15:50:50
...
class Ui_MainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.helpInputLabel = QtWidgets.QLabel()
        ...
        self.gridForm.addWidget(self.helpInputLabel, 2, 1, Qt.AlignRight | Qt.AlignTop)
        # 填充空隙
        self.gridForm.addWidget(QtWidgets.QLabel(), 3, 0)
        ...
        self.HVBoxMain.addLayout(self.vboxRight, stretch=0)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.helpInputLabel.setText(_translate('mainWindow', '帮助'))
...
class folderInputWindow(object):
    def setupUi(self, mainWindow):
        self.setWindowTitle('项目效果图整理')
        self.resize(500,500)
